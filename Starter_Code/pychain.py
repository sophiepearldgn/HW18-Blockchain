...
class Block:
    ...
    def hash_block(self):
        ...
        # Convert the 'record' attribute to bytes and update the hash
...
if st.button("Add Block"):
    ...
    # and `amount` values
# Record object with sender, receiver, and amount
    input_data = Record(sender, receiver, amount) 
...
# providing a unique key for each slider
difficulty = st.sidebar.slider("Block Difficulty 1", 1, 5, 2)
